...
public class VulkanMain {
	...
	private Vertex[] vertices = new Vertex[10000];
    ...
    private void createVertexBuffer() {
        ...
        try(MemoryStack stack = stackPush()) {
            ...
            vkbase.createBuffer(bufferSize,
            ...
            vkbase.copyBuffer(stagingBuffer, vertexBuffer, bufferSize);
    ...
    private void recordCommandBuffer(VkCommandBuffer commandBuffer, int index) {
        ...
        try(MemoryStack stack = stackPush()) {
            ...
            renderPassInfo.framebuffer(vkbase.swapChainFramebuffers.get(index));
...
//        	System.out.println(currentFrame + " " + imageIndex);
